...
# Gurantees
`Vec` makes a lot of gurantees about its  design.This ensure its a low-overhead as possible in the genral case,and can be correctly manipulated in primitive ways to unsafe code.
